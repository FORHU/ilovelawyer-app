 ...
 * - "pending-persona": the feature works but its AI grounding isn't tenant-aware yet.
 * - "coming-soon": not implemented for this tenant yet; gated from the UI.
 */
 ...
 * Tenant, never by this frontend config.
 */
