      ...
      <div className="max-w-360 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
          ...
          <div className="md:col-span-2 flex flex-col gap-6">
            <h4 className="text-black text-xs tracking-[1.2px] uppercase" style={{ fontFamily: "Inter, sans-serif", fontWeight: 600 }}>{t("footer.company.heading")}</h4>
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <h4 className="text-black text-xs tracking-[1.2px] uppercase" style={{ fontFamily: "Inter, sans-serif", fontWeight: 600 }}>{t("footer.legal.heading")}</h4>
            <div className="flex flex-col gap-4">
