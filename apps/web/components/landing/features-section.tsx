      ...
      <div className="relative z-10 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-12 gap-8 mb-8">
          <div className="col-start-2 col-span-10 flex items-end justify-between pb-16">
            ...
            <button
              className="flex flex-col items-start shrink-0 pb-1.5 border-b-2 border-black cursor-pointer bg-transparent border-t-0 border-l-0 border-r-0 hover:opacity-70 transition-opacity"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* AI Research Chat */}
          <div className="lg:col-start-2 lg:col-span-5 h-[400px] backdrop-blur-[6px] bg-[rgba(247,250,252,0.4)] border border-[rgba(198,198,206,0.3)] flex flex-col justify-between p-10">
          ...
          {/* Case Manager */}
          <div className="lg:col-span-5 h-[400px] bg-[#2d3133] relative overflow-hidden flex flex-col justify-between p-10">
            ...
            <button className="relative z-10 self-start border-b border-[#ffe088] pb-1 cursor-pointer bg-transparent border-t-0 border-l-0 border-r-0 hover:opacity-80 transition-opacity">
          ...
          {/* Document Analysis */}
          <div className="lg:col-start-2 lg:col-span-10 h-[320px] bg-white border border-[rgba(198,198,206,0.3)] flex items-center">
            <div className="flex items-center gap-8 p-10 w-full h-full">
              <div className="flex-1 flex flex-col gap-4">
                <FileSearch size={27} color="black" />
                <h3 className="text-[28px] text-black leading-[36px] pt-2" style={{ fontFamily: "'Libre Caslon Text', serif", fontWeight: 400 }}>
                  Document Analysis
                </h3>
                <p className="text-[#45464d] text-base leading-[1.6]" style={{ fontFamily: "Inter, sans-serif" }}>
          ...
          {/* Voice Transcription */}
          <div className="lg:col-start-2 lg:col-span-10 h-[280px] bg-[#ebeef0] flex items-center">
            <div className="flex items-center justify-between p-10 w-full">
              ...
              <div className="border border-black rounded-full size-16 flex items-center justify-center shrink-0">
                <Mic size={20} color="#181C1E" />
              </div>
            </div>
          </div>
        </div>
