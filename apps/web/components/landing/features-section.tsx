...
export function FeaturesSection() {
  return (
    <section className="bg-[#f2f4f6] dark:bg-[#111f2e] py-24 px-6 md:px-16">
      <div className="max-w-[1200px] mx-auto flex flex-col gap-16 items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
          <div className="bg-white dark:bg-[#152840] rounded-xl border border-[#d8dadc] dark:border-[#1e3350] p-8 lg:col-span-2">
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              <div className="flex-1 flex flex-col gap-4">
                ...
                <h3
                  className="text-[#191c1e] dark:text-[#e2e8f0] text-2xl pt-1"
                  style={{ fontFamily: "'Source Serif 4', serif", fontWeight: 400 }}
                >
                  Institutional Legal Context
                </h3>
                <p className="text-[#44474d] dark:text-[#94a3b8] text-base leading-[1.625]" style={{ fontFamily: "'Source Serif 4', serif" }}>
                ...
                <div className="flex flex-col gap-2 pt-4">
                  {["Multi-jurisdictional Analysis", "Statute Synchronization"].map((item) => (
                    <div key={item} className="flex items-center gap-2">
                      ...
                      <span className="text-[#191c1e] dark:text-[#e2e8f0] text-sm" style={{ fontFamily: "'Source Serif 4', serif" }}>
                        {item}
                      </span>
                    </div>
                  ))}
              ...
              <div className="flex-1 min-h-[192px] rounded-lg overflow-hidden bg-[#e8edf5] dark:bg-[#1e3350] flex items-center justify-center">
                <span className="text-[#76849f] dark:text-[#4a5568] text-sm" style={{ fontFamily: "'Source Serif 4', serif" }}>Columns image</span>
              </div>
            </div>
          </div>

          <div className="bg-white dark:bg-[#152840] rounded-xl border border-[#d8dadc] dark:border-[#1e3350] p-8">
            <svg className="w-[33px] h-[27px]" fill="none" viewBox="0 0 33.3361 26.6667">
              <path d={svgPaths.p2cbc7d80} fill="#0059BB" />
            </svg>
            <h3
              className="text-[#191c1e] dark:text-[#e2e8f0] text-xl pt-5 pb-3"
              style={{ fontFamily: "'Source Serif 4', serif", fontWeight: 400 }}
            >
              Rapid Synthesis
            </h3>
