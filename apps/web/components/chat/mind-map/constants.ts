...
export const MIND_MAP_CHROME = {
  ...
  toggleOff:
    'flex items-center gap-2 px-3 py-1 md:px-3.5 md:py-1.5 rounded-full shadow-lg transition-all border border-border bg-card/90 text-foreground font-black',
  toggleOn:
    'flex items-center gap-2 px-3 py-1 md:px-3.5 md:py-1.5 rounded-full shadow-lg transition-all border border-foreground bg-foreground text-background font-black',
  accentBtn:
