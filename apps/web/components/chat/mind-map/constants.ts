...
export const MIND_MAP_CHROME = {
  ...
  // accent, the stale one in amber so an out-of-date map still stands out.
  regenerateIconBtn:
    'flex items-center justify-center size-9 rounded-xl backdrop-blur-md shadow-lg transition-all border border-brand-gold/30 bg-brand-gold text-brand-navy-950 hover:scale-105 active:scale-95 disabled:opacity-60 disabled:pointer-events-none',
  staleIconBtn:
    'flex items-center justify-center size-9 rounded-full backdrop-blur-md shadow-lg transition-all border border-amber-500/40 bg-amber-500/10 text-amber-700 dark:text-amber-400 hover:bg-amber-500/20 active:scale-95 disabled:opacity-60 disabled:pointer-events-none',
