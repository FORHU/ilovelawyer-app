...
// STUDIO_MINDMAP_WIDTH below) — still just a ceiling, so Timeline/Audio Overview stay at
// whatever width the user actually left the panel at.
...
// Same one-time floor, for Data Table's 3-column layout — at the panel's plain minimum
// (STUDIO_MIN_WIDTH), the columns had nowhere to go but crush down to near-unreadable. Doesn't
// need Mind Map's canvas room, just enough for Type/Label/Detail to read comfortably.
const STUDIO_DATATABLE_WIDTH = 480;
      ...
      {isDesktop ? (
        <div className="flex min-h-0 flex-1">
          ...
          <StudioPanel
            ...
            onOpenDataTable={() => studio.requestWidth(STUDIO_DATATABLE_WIDTH)}
