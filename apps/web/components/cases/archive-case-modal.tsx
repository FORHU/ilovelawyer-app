...
export default function ArchiveCaseModal({ caseRecord, isArchiving, onConfirm, onClose }: ArchiveCaseModalProps) {
      ...
      <DialogContent showCloseButton={false} className="max-w-md gap-0 overflow-hidden p-0">
        ...
        <div className="px-6 py-6 flex gap-4">
          ...
          <DialogDescription asChild>
            <p className="text-sm text-foreground leading-relaxed">
              {t("archiveConfirm", { caseName: caseRecord.caseName })}
            </p>
          </DialogDescription>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-border bg-muted/40">
          <Tooltip>
            ...
            <TooltipContent>Keep this case active and close without archiving</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
              <button
              ...
              >
                ...
                {isArchiving ? t("archiving") : t("archiveCaseCta")}
              </button>
            </TooltipTrigger>
            <TooltipContent>Move {caseRecord.caseName} to the Archived tab</TooltipContent>
          </Tooltip>
        </div>
      </DialogContent>
    </Dialog>
